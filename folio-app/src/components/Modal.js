    ...
    return (
        <div>
            ...
            <div className="modal-body bio-text">
                <div className="bio">
                    <div>
                        <img className="profile-pic img-thumbnail" alt="Profile of Teresa Maldonado" src="../public/images/profile-pic.jpeg"/>
                    </div>
                    <div>
...
{/* <!-- Contact Modal --> */}
            ...
            <div className="modal-header">
                <h5 className="modal-title" id="Contact">So you want to chat?</h5>
                <button type="button" className="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
